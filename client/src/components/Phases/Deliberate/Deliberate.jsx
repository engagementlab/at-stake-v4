...
class Deliberate extends PureComponent {
  ...
  componentDidMount() {
    ...
    this.socket.on('game:next_screen', () => {
      ...
      if (!this.state.isFacilitator) { this.setState({ screenIndex: this.state.screenIndex + 1 }); }
    });
            ...
            <div>
              ...
              <div className="grid">
                {Object.keys(data.players).map((id) => {
                  ...
                  const classStr = `player${player.isFacilitator ? ' facilitator' : ''}`;
                    ...
                    <div className="buttons">
                      ...
                      {i === 0 && (
                        <span className="tooltip-content">
                          You can choose to accept or ignore events that will complicate players' solutions.
                        </span>
                      )}
        ...
        <div id="vote">
          ...
          {isFacilitator && (
            <div>
              ...
              />
              <h1>
                {`${voting.callerName} called a vote!` }
              </h1>
            </div>
          )}
